...
if (get_option ('wavatar_auto') == '')
    add_option ('wavatar_auto', true);
add_action('admin_menu', 'wavatar_add_pages');
add_filter('get_comment_author','wavatar_comment_author',1);
add_action('wp_footer', 'wavatar_plug');
